...
<div class="lgw-content-section">
	<h2><?php echo $locale->t( 'connection.catalog.link_title' ); ?></h2>
	<p><?php echo $locale->t( 'connection.catalog.link_description' ); ?></p>
	<p>
		<span><?php echo count($catalog_list); ?></span>
		<?php echo $locale->t( 'connection.catalog.link_catalog_avalaible' ); ?>
	</p>
</div>
<div>
	<div class="lgw-catalog-select">
		<label class="control-label" for="select_catalog">
            <?php echo Lengow_Configuration::get( 'blogname' ); ?>
		</label>
		<select class="form-control lengow_select js-catalog-linked"
		        id="select_catalog"
		        name="catalog_ids"
		        multiple="multiple"
		        data-placeholder="<?php echo $locale->t( 'connection.catalog.link_placeholder_catalog' ); ?>"
	...
	<button class="lgw-btn lgw-btn-green lgw-btn-progression js-link-catalog">
		<div class="btn-inner">
			<div class="btn-step default">
				<?php echo $locale->t( 'connection.catalog.link_button' ); ?>
			</div>
