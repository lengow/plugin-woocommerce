...
<ul class="nav nav-pills lengow-nav lengow-nav-top">
	...
	<li role="presentation" class="<?= ($current_page == 'lengow_admin_products') ? "active" : "" ?>"><a href="
            <?= admin_url('admin.php?page=lengow&tab=lengow_admin_products'); ?>">
			<?= $locale->t('menu.product') ?>
		</a>
	</li>
	<li class="lengow_float_right <?= ($current_page == 'lengow_admin_settings') ? "active" : "" ?>" id="menugotosetting">
	...
	<li class="lengow_float_right <?= ($current_page == 'lengow_admin_help') ? "active" : "" ?>" id="menugotohelp">
