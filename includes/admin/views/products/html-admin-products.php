                        ...
                        <div class="lengow_table_top">
                            <div id="lgw-product-toolbar" class="js-lengow_toolbar" style="display:none;">
                                <a href="#"
                                   ...
                                   data-message="<?php echo esc_attr( $locale->t( 'product.screen.remove_confirmation',
                                ...
                                <a href="#"
                                   ...
                                   data-action="export_mass_action"
                                   data-message="<?php echo esc_attr( $locale->t( 'product.screen.add_confirmation',
									   array( 'nb' => $shop['select_all'] ) ) ); ?>"
                                ...
                                <div class="js-lengow_select_all">
                                    ...
                                    <span><?php echo esc_html( $locale->t( 'product.screen.select_all_products',
