...
<div class="lgw-container" id="lengow_mainsettings_wrapper" xmlns="http://www.w3.org/1999/html">
	...
	<form class="lengow_form" method="POST">
		...
		<div class="lgw-box">
			...
			<label class="control-label"><?php echo $locale->t('global_setting.screen.product_types_title'); ?></label>
			<div class="form-group">
			...
			<span class="legend" style="display:block;"><?php echo $locale->t('global_setting.screen.product_types_legend'); ?></span>
		</div>
		<div class="lgw-box">
			...
			<div id="lengow_wrapper_import">
				<div class="grey-frame">
					<div class="form-group">
						...
						<span class="legend" style="display:block;"><?php echo $keys['lengow_import_days']['legend']?></span>
					</div>
					<div class="form-group">
						<div class="lgw-switch <?php echo $values['lengow_import_ship_mp_enabled'] == 1 ? 'checked' : '' ;?>">
							<label>
								<div>
									<span></span>
			...
			<span class="legend" style="display:block;"><?php echo $locale->t('lengow_settings.lengow_import_enabled_legend'); ?></span>
		</div>
		<div class="lgw-box">
