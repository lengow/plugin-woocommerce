...
<div class="lgw-container lgw-toolbox-wrapper">
	...
	<?php endif; ?>
    <h2><i class="fa fa-rocket"></i> <?php echo $locale->t( 'toolbox.screen.title' ); ?></h2>
    <div class="lgw-box">
        <div class="lgw-switch checked js-lgw-global">
            <label>
	            ...
	            <?php echo $locale->t( 'toolbox.screen.global_information' ); ?>
            </label>
        </div>
        <div class="js-lgw-global-content">
            <div class="lgw-box-content">
                <h3>
	                ...
	                <?php echo $locale->t( 'toolbox.screen.checklist_information' ); ?>
                </h3>
            ...
            <div class="lgw-box-content">
                <h3>
                    <i class="fa fa-cog"></i>
	                <?php echo $locale->t( 'toolbox.screen.plugin_information' ); ?>
                </h3>
            ...
            <div class="lgw-box-content">
                <h3>
	                ...
	                <?php echo $locale->t( 'toolbox.screen.synchronization_information' ); ?>
                </h3>
    ...
    <div class="lgw-box">
        <div class="lgw-switch js-lgw-export">
            <label>
	            ...
	            <?php echo $locale->t( 'toolbox.screen.shop_information' ); ?>
            </label>
        </div>
        <div class="js-lgw-export-content">
            <div class="lgw-box-content">
                <h3>
	                ...
	                <?php echo $locale->t( 'toolbox.screen.export_information' ); ?>
                </h3>
            ...
            <div class="lgw-box-content">
                <h3>
	                ...
	                <?php echo $locale->t( 'toolbox.screen.content_folder_media' ); ?>
                </h3>
	            <?php echo $toolbox_element->get_file_information(); ?>
            </div>
        </div>
    </div>
    <div class="lgw-box">
        <div class="lgw-switch js-lgw-checksum">
            <label>
	            ...
	            <?php echo $locale->t( 'toolbox.screen.checksum_integrity' ); ?>
            </label>
        </div>
