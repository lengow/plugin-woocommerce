...
class Fixture extends PHPUnit_Framework_TestCase
{
    public function create_item($rest_request) {
        ...
        if (!isset($rest_request['status'])) $rest_request['status'] = 'publish';
        if (!isset($rest_request['name'])) $rest_request['name'] = 'name';
        //$rest_request['type'] = 'simple';
        if (!isset($rest_request['description'])) $rest_request['description'] = 'description';
        if (!isset($rest_request['short_description'])) $rest_request['short_description'] = 'short_description';
