...
class Lengow_ConnectorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testFormat() {
		...
		$this->assertEquals( "simple,plop,/1233;variable", $fixture->invokeMethod( $connector, "format", array(
		...
		$this->assertEquals( new SimpleXMLElement( $string ), $fixture->invokeMethod( $connector, "format", array(
			$string,
			"xml"
		) ) );
		$this->assertEquals( "simple,plop,/1233;variable", $fixture->invokeMethod( $connector, "format", array(
		...
		$this->assertEquals( '', $fixture->invokeMethod( $connector, "format", array(
			"simple,plop,/1233;variable",
			"plop"
		) ) );
	}
